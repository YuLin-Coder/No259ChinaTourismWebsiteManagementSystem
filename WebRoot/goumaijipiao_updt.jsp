...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="goumaijipiaoupdate.do" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    ${mmm.feijipiaobianhao}<input type="hidden" id="feijipiaobianhao" name="feijipiaobianhao" value="${Info.html(mmm.feijipiaobianhao)}"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    ${mmm.hangbanhao}<input type="hidden" id="hangbanhao" name="hangbanhao" value="${Info.html(mmm.hangbanhao)}"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    ${mmm.suoshuhangkonggongsi}<input type="hidden" id="suoshuhangkonggongsi" name="suoshuhangkonggongsi" value="${Info.html(mmm.suoshuhangkonggongsi)}"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    ${mmm.qifeishijian}<input type="hidden" id="qifeishijian" name="qifeishijian" value="${Info.html(mmm.qifeishijian)}"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    ${mmm.qifeichengshi}<input type="hidden" id="qifeichengshi" name="qifeichengshi" value="${Info.html(mmm.qifeichengshi)}"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    ${mmm.daodachengshi}<input type="hidden" id="daodachengshi" name="daodachengshi" value="${Info.html(mmm.daodachengshi)}"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    ${mmm.daodashijian}<input type="hidden" id="daodashijian" name="daodashijian" value="${Info.html(mmm.daodashijian)}"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    ${mmm.jianpiaokou}<input type="hidden" id="jianpiaokou" name="jianpiaokou" value="${Info.html(mmm.jianpiaokou)}"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    ${mmm.jipiaojiage}<input type="hidden" id="jipiaojiage" name="jipiaojiage" value="${Info.html(mmm.jipiaojiage)}"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入身份证号" style="width:150px;" data-rule-required="true" data-msg-required="请填写身份证号" remote="checkno.do?checktype=update&id=${mmm.id}&table=goumaijipiao&col=shenfenzhenghao" data-msg-remote="内容重复了" idcard="true" data-msg-email="请输入有效身份证号码" id="shenfenzhenghao" name="shenfenzhenghao" value="${Info.html(mmm.shenfenzhenghao)}"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入购买用户" style="width:150px;" readonly="readonly" id="goumaiyonghu" name="goumaiyonghu" value="${mmm.goumaiyonghu}"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                            ...
                                            <input name="id" value="${mmm.id}" type="hidden"/>
                                                <input name="feijipiaoid" value="${mmm.feijipiaoid}" type="hidden"/>
