...
<div class="panel panel-default">
    ...
    分类
                            ...
                            <select class="form-control class_fenlei17" data-value="${param.fenlei}" data-rule-required="true" data-msg-required="请填写分类" id="fenlei" name="fenlei">
...
<th> 点击率  </th>
                    ...
                    <tr id="${map.id}" pid="">
                        ...
                        <td> ${map.biaoti} </td>
<td> <ssm:sql var="mapxinwenfenlei1" type="find">SELECT fenleimingcheng FROM xinwenfenlei where id='${map.fenlei}'</ssm:sql>${mapxinwenfenlei1.fenleimingcheng} </td>
<td> <c:choose>
