...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="jiudiankefanginsert.do" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <select class="form-control class_kefangleixing4" data-value="" id="kefangleixing" name="kefangleixing" style="width:250px">
...
<option value="套房">套房</option>
    ...
    <input type="text" class="form-control" data-rule-required="true" data-msg-required="请填写客房图片" id="kefangtupian" name="kefangtupian" value=""/>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="输入客房价格" style="width:150px;" step="0.01" data-rule-required="true" data-msg-required="请填写客房价格" number="true" data-msg-number="输入一个有效数字" id="kefangjiage" name="kefangjiage" value=""/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="输入剩余客房数" style="width:150px;" number="true" data-msg-number="输入一个有效数字" id="shengyukefangshu" name="shengyukefangshu" value=""/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                                ...
                                                                <input type="hidden" name="jiudianid" value="${param.id}"/>
