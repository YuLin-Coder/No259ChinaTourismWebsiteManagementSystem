...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="jiudianupdate.do" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入酒店编号" style="width:150px;" readonly="readonly" id="jiudianbianhao" name="jiudianbianhao" value="${Info.html(mmm.jiudianbianhao)}"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入酒店名称" style="width:150px;" data-rule-required="true" data-msg-required="请填写酒店名称" id="jiudianmingcheng" name="jiudianmingcheng" value="${Info.html(mmm.jiudianmingcheng)}"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <select class="form-control class_jiudianleixing2" data-value="${Info.html(mmm.jiudianleixing)}" data-rule-required="true" data-msg-required="请填写酒店类型" id="jiudianleixing" name="jiudianleixing" style="width:250px">
...
<script>
$(".class_jiudianleixing2").val($(".class_jiudianleixing2").attr("data-value"))</script>
    ...
    <input type="text" class="form-control" data-rule-required="true" data-msg-required="请填写酒店图片" id="jiudiantupian" name="jiudiantupian" value="${Info.html(mmm.jiudiantupian)}"/>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入酒店地址" style="width:150px;" data-rule-required="true" data-msg-required="请填写酒店地址" id="jiudiandizhi" name="jiudiandizhi" value="${Info.html(mmm.jiudiandizhi)}"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <textarea style="width: 80%;height: 120px" class="form-control" placeholder="输入酒店介绍" id="jiudianjieshao" name="jiudianjieshao">${Info.html(mmm.jiudianjieshao)}</textarea>                                            
        </div>
