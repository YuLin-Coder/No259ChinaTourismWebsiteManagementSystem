            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" action="?"><!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_kefangleixing6" data-value="${param.kefangleixing}"
                        ...
                        <script>
                            $(".class_kefangleixing6").val($(".class_kefangleixing6").attr("data-value"))</script>
                    ...
                    <c:set var="i" value="0"/><c:forEach items="${list}" var="map"><c:set var="i" value="${i+1}"/>
                        <tr id="${map.id}" pid="">
                            ...
                            <td align="center">
                                ...
                                <a href="jiudianyuding_updt.do?id=${map.id}">编辑</a>
                                <a href="jiudianyuding_delete.do?id=${map.id}" onclick="return confirm('确定要删除？')">删除</a>
                                <!--qiatnalijne-->
                            </td>
                        </tr>
                    </c:forEach>
