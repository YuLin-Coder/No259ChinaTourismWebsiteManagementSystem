...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="jingdiangonglueinsert.do" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入景点编号" style="width:150px;" readonly="readonly" id="jingdianbianhao" name="jingdianbianhao" value="${Info.getID()}"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入景点名称" style="width:150px;" data-rule-required="true" data-msg-required="请填写景点名称" id="jingdianmingcheng" name="jingdianmingcheng" value=""/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="hidden" data-rule-required="true" data-msg-required="请填写景点图片" id="jingdiantupian" name="jingdiantupian" value=""/>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入所在城市" style="width:150px;" data-rule-required="true" data-msg-required="请填写所在城市" id="suozaichengshi" name="suozaichengshi" value=""/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="输入门票价格" style="width:150px;" step="0.01" data-rule-required="true" data-msg-required="请填写门票价格" number="true" data-msg-number="输入一个有效数字" id="menpiaojiage" name="menpiaojiage" value=""/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入开放时间" style="width:150px;" data-rule-required="true" data-msg-required="请填写开放时间" id="kaifangshijian" name="kaifangshijian" value=""/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <textarea id="gongluexiangqing" name="gongluexiangqing" style="max-width: 750px;width:100%; height: 300px;"></textarea><script>
            (function(){
